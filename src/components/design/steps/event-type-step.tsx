...
const EVENT_TYPES: EventTypeOption[] = [
  {
    ...
    emoji: '❤️',
    title: 'Charity Event',
    description: 'Fundraisers, galas, awareness campaigns',
  },
  {
    type: 'fundraiser',
    emoji: '💰',
    title: 'Fundraiser',
    description: 'School fundraisers, community drives',
  },
  {
    type: 'company',
    emoji: '🏢',
    title: 'Company Event',
    description: 'Corporate events, team building, conferences',
  },
  {
    type: 'sports',
    emoji: '⚽',
    title: 'Sports League',
    description: 'Team uniforms, tournament gear',
  },
  {
    type: 'school',
    emoji: '🎓',
    title: 'School',
    description: 'Class shirts, club merchandise',
  },
  {
    type: 'personal',
    emoji: '🎉',
    title: 'Personal',
    description: 'Family reunions, parties, celebrations',
  },
];
